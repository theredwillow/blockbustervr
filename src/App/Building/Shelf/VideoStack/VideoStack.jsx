            ...
            this.videos.push( (
                <a-entity key={v} position={this.position.join(" ")} rotation={this.rotation.join(" ")}>
                    <a-plane class="video-front"
                        material={"src:#dvd_" + cover + "; repeat:-0.475 1; side:back;"}
                        height="0.32" width="0.2" position="0 0 0.015" rotation="0 180 0"></a-plane>
                    { /* Need to fix material placement on curve */ }
                    <a-plane class="video-curve"
                        material={"src:#dvd_" + cover + "; repeat:0.03 1;"}
                        height="0.32" width="0.03" position="-0.1 0 0" rotation="0 -90 0"></a-plane>
                    <a-plane class="video-back"
                        material={"src:#dvd_" + cover + "; repeat:0.475 1;"}
                        height="0.32" width="0.2" position="0 0 -0.015" rotation="0 180 0"></a-plane>
